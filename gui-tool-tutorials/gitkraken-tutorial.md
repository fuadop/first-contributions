...
[<img align="right" width="150" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/join-slack-team.png?raw=true">](https://join.slack.com/t/firstcontributors/shared_invite/enQtNjkxNzQwNzA2MTMwLTVhMWJjNjg2ODRlNWZhNjIzYjgwNDIyZWYwZjhjYTQ4OTBjMWM0MmFhZDUxNzBiYzczMGNiYzcxNjkzZDZlMDM)
...
|<img alt="GitKraken" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-icon.png?raw=true" width="200">|GitKraken Edition|
|---|---|
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-login.png?raw=true" alt="login to GitHub" />
...
<img align="right" width="300" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/fork.png?raw=true" alt="fork this repository" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-clone.png?raw=true" alt="clone this repository" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-branch.png?raw=true" alt="name your branch" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-edit.png?raw=true" alt="edit some file(s)" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-stage.png?raw=true" alt="stage your changes" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-commit.png?raw=true" alt="clone this repository" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-push.png?raw=true" alt="push your changes" />

Click the Push button on the toolbar.

<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/gk-origin.png?raw=true" alt="origin or branch" />
...
<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/compare-and-pull.png?raw=true" alt="create a pull request" />

Now submit the pull request.

<img style="float: right;" src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/gitkraken-tutorial/submit-pull-request?raw=true" alt="submit pull request" />
