...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-clone.png?raw=true" alt="Clone Popup (Command Popup)" />
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-clone1.png?raw=true" alt="Clone repo" />

Now type in `git clone`, only `git` or `clone` (it works like a search).
Select the Entry `Git: Clone` and press `Enter`

<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-clone2.png?raw=true" alt="Paste Repository URL in" />
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-clone3.png?raw=true" alt="Status popup" />
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-branch.png?raw=true" alt="Branches Command Palette" />
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-changes.png?raw=true" alt="Add your name" />
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-commit.png?raw=true" alt="Commit changes" />
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-commit1.png?raw=true" alt="Stashed Files">
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-push.png?raw=true" alt="Stashed Files">
...
<img src="https://github.com/firstcontributions/assets/blob/master/gui-tool-tutorials/github-windows-vs-code-tutorial/vscode-2018-08-gh-auth.png?raw=true" alt="Stashed Files">
